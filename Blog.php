...
<div class="container">
	<div class="row">
		<div class="col-sm-8 "  >
            ...
            //Query when query is active in URL tab
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<small class="text-muted">Category: <span class="text-dark"><?php echo $Category; ?> </span> & Written by <span class="text-dark"><a href="Profile.php?username=<?php echo htmlentities($Admin);?>"><?php echo htmlentities($Admin); ?></a></span> on <?php echo $DateTime;?></small>

					<span style="float:right;" class="badge badge-dark text-light">Comments <?php echo ApprovedCommentsAccordingtoPost($PostId);  ?></span>
